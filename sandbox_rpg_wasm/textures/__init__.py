...
class TextureGenerator:
    ...
    def generate_all(self) -> None:
        ...
        mobs.generate_snake(self)
        mobs.generate_kobold(self)
        mobs.generate_hobgoblin(self)
        mobs.generate_bear(self)
        mobs.generate_orc_archer(self)
        mobs.generate_mephit_fire(self)
        mobs.generate_mephit_ice(self)
        mobs.generate_mephit_lightning(self)
        mobs.generate_ogre(self)
        mobs.generate_ogre_mage(self)
        mobs.generate_centaur(self)
        mobs.generate_golem(self)
        mobs.generate_dragon_red(self)
        mobs.generate_dragon_green(self)
        mobs.generate_dragon_black(self)
        mobs.generate_dragon_white(self)
        mobs.generate_shadow_dragon(self)
        # Resources
